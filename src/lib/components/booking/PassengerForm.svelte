...
const concessionOptions = $derived([
    { value: 'none', label: m.passenger_concession_none() },
    { value: 'senior', label: m.passenger_concession_senior() },
    { value: 'student', label: m.passenger_concession_student() },
    { value: 'pwd', label: m.passenger_concession_pwd() }
]);
...
function onGender(value) {
    passengers.setGender(index, value);
}
function onConcession(value) {
    passengers.setConcession(index, value);
}
function onAccessibility(value) {
    passengers.setAccessibility(index, value);
}
</script>
