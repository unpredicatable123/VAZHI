...
class PreferencesStore {
	...
	get snapshot(): AccessibilityPreferences {
		return {
	...
	setAccessibleTravelMode(enabled: boolean): void {
	...
	private apply(): void {
		...
		if (this.largerText) root.dataset.textSize = 'large';
		else delete root.dataset.textSize;
		if (this.reducedMotion) root.dataset.motion = 'reduced';
