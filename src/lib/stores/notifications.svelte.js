...
function load() {
    ...
    try {
        ...
        return {
            ...
            boardingReminder: lead === 'off' || lead === '15' || lead === '30' || lead === '60'
                ? lead
...
class NotificationStore {
    ...
    boardingReminder = $state(defaultNotificationPreferences.boardingReminder);
    ...
    setDisruptionAlerts(value) {
        this.disruptionAlerts = value;
        this.persist();
    }
    setBoardingReminder(value) {
        this.boardingReminder = value;
        this.persist();
    }
    setWomenNearbySignals(value) {
