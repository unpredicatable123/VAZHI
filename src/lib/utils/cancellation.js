 ...
 */
export function parseDepartureTimestamp(travelDate, departureTime) {
 ...
 */
export function checkCancellationEligibility(travelDate, departureTime, now = new Date()) {
 ...
 */
export function calculateRefundBreakdown(totalPaid) {
