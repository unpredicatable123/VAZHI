...
export function saveTicketFile(booking: Booking, labels: Record<string, string>): void {
	const lines = [
...
export function saveCalendarFile(booking: Booking, labels: Record<string, string>): void {
