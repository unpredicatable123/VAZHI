...
eq(
	'production ticket',
	referenceFromScan('https://vazhi-9a321.web.app/conductor/verify?pnr=VZ-DE67A8D7A6'),
	'VZ-DE67A8D7A6'
);
eq(
	'localhost, during development',
	referenceFromScan('http://localhost:5173/conductor/verify?pnr=VZ-11D0830'),
	'VZ-11D0830'
);
eq(
	'reference lower-cased by some re-encoder',
	referenceFromScan('https://vazhi-9a321.web.app/conductor/verify?pnr=vz-de67a8d7a6'),
	'VZ-DE67A8D7A6'
);
eq(
	'extra query parameters alongside it',
	referenceFromScan('https://vazhi-9a321.web.app/conductor/verify?utm=x&pnr=VZ-ABC123&y=2'),
	'VZ-ABC123'
);
